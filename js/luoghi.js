...
const Luoghi = (() => {
  ...
  const LUOGHI = {
    ...
    scauri: {
      ...
      guarda: [
        ['La macchina, di tre quarti', 'Station wagon vista da dietro e di sbieco, col **portellone alzato**: il lunotto in alto è pallido perché ci sta dietro il cielo, e sotto il vano è buio. È quel contrasto che dice «aperto».'],
        ['Il baule, dentro', 'La lucina è accesa e la sua luce cade sul piano di carico. Ci sono **le pinne in piedi**, **il borsone** coi due manici, e **il telo da mare piegato in tre**. È il primo inventario del gioco, e si vede prima di averlo.'],
        ['Le due ruote sul marciapiede', 'Parcheggiata come si parcheggia quando si parte per quattro giorni: di sbieco, il muso alzato sul cordolo, e nessuno che abbia intenzione di rimetterla dritta.'],
        ['Il borsone in mezzo alla strada', 'Sull\'asfalto, dietro la macchina: quello che nessuno dei due ha deciso di caricare per primo. Manici, cerniera, la tracolla per terra.'],
        ['La sabbia scura', 'Sabbia vulcanica, quasi nera dove è bagnata. E la riga di schiuma con **due impronte** che vanno all\'acqua e non tornano: qualcuno si è fatto il bagno alle sette meno un quarto, e non sono loro.'],
        ['Il promontorio, a destra', 'Monte Orlando, che chiude il golfo di Gaeta. Controluce all\'alba è quasi nero, e la cima è un tavolato, non una gobba.'],
        ...
        ['Il lampione', 'Tagliato dal bordo di sopra, ancora accesa la sua luce: a quest\'ora i lampioni del lungomare non li ha spenti nessuno.'],
      ],
