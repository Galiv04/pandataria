...
const Luoghi = (() => {
  ...
  const LUOGHI = {
    ...
    scauri: {
      ...
      guarda: [
        ['La macchina', 'Station wagon, di profilo, col **portellone alzato** e la lucina del baule accesa. È la sagoma che dice «si sta caricando» senza bisogno di spiegarlo.'],
        ['Il borsone in terra', 'Accanto al portellone aperto: quello che nessuno dei due ha deciso di caricare per primo. Manici, cerniera, la tracolla per terra.'],
        ['L\'acqua', 'Una lastra. Nessuna onda — non c\'è vento — e la fascia più chiara vicino a riva, dove il fondo si alza.'],
        ['La battigia', 'La riga di schiuma e, poco sopra, **due impronte** che vanno all\'acqua e non tornano. Qualcuno si è fatto il bagno alle sette meno un quarto, e non sono loro.'],
        ...
        ['Il lampione', 'Tagliato dal bordo di sopra, ancora accesa la sua luce: a quest\'ora i lampioni del lungomare non li ha spenti nessuno. È lui che dà la misura a tutto il resto.'],
      ],
